 ...
 */
	public class VisiblePlugin extends TweenPlugin {
		...
		override public function setRatio(v:Number):void {
			_target.visible = ((v == 1 || v == 0) && _tween._time / _tween._duration == _progress) ? _visible : _initVal; //a ratio of 1 doesn't necessarily mean the tween is done - if the ease is Elastic.easeOut or Back.easeOut, for example, it could it 1 mid-tween. We check for a progress of 0 because from() tweens would require it.
		}
