package burnt.z-unused.burn.world.effects
{
	...
	public class DamageNumberCount extends Entity
	{
		private var _number:Number = 2;
		private var _maxNumber:Number = 100;
		...
		public function DamageNumberCount( value:Number = 0 ) 
		{
		...
		{
			trace("MX " + this._number + " ROPE " + this._number );
			
			this.removeCount -= 1;
			
			//if ( this.removeCount < 0 ) this.destroy();
			
			if ( this._number < this._maxNumber ) this._number += 1;
			renderNumber ();
		}
		...
		public function renderNumber ():void
		{
			...
			trace("are you rendering the number ");
