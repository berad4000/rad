package rad.rad.burn.world
{
	...
	import rad.rad.burn.world.elements.WorldView;
	import rad.rad.burn.world.souls.types.Bombshell;
	import rad.rad.burn.world.souls.types.Babe;
	import rad.rad.burn.ui.TitleScreen;
	import rad.vs.avatar.toons.Toon;
	...
	public class Student extends StarWorld 
	{ 
