package rad.rad.burn.world
{
	...
	import rad.rad.burn.ui.TitleScreen;
	...
	import rad.rad.burn.world.souls.types.Cop;
	import rad.rad.burn.world.souls.types.Focus;
	import rad.rad.burn.world.souls.types.Horse;
	import rad.rad.burn.world.souls.types.PussyShot;
	import rad.vs.soul.Soul;
	import rad.vs.soul.commands.FocalPointUpdateX;
	import rad.vs.soul.commands.FocalPointUpdateY;
	import rad.vs.soul.commands.ModeUpdate;
	...
	import rad.vs.world.star.Background;
	import rad.vs.world.star.BackgroundLayer;
	...
	public class BurnWorld extends StarWorld
	{
		...
		override public function awake ( model:VsModel, control:VsControl ):void
		{
		...
		{
			trace("are you checking the level complete ");
			
			trace("copRemain " + copRemain );
		...
		private function shotOver( group:Array  ):void
		{
			...
			for ( var i:Number = 0; i < this.copAmount; i++ )
			{
				...
				if (bounds1.intersects(bounds2)) 
				{
					...
					trace("damage looks like " + damage );
